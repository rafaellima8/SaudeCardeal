...
async function seedCareLines() {
  ...
  const prenatalFields = [
    // DADOS OBSTÉTRICOS
    {
      ...
      required: true,
      order: 1,
      validationRules: JSON.stringify({ min: 1, max: 42 }),
    ...
    },
    {
      ...
      required: false,
      order: 2,
      validationRules: JSON.stringify({ min: 0, max: 6 }),
    ...
    },
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Sim", "Não", "Não sabe"]),
      required: true,
      order: 5,
      createdAt: new Date(),
    },
    ...
    // DADOS CLÍNICOS ESPECÍFICOS
    {
      ...
      required: false,
      order: 16,
      validationRules: JSON.stringify({ min: 10, max: 50 }),
    ...
    },
    {
      ...
      required: false,
      order: 17,
      validationRules: JSON.stringify({ min: 100, max: 180 }),
    ...
    },
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Presentes", "Ausentes", "Não avaliado"]),
      required: false,
      order: 18,
      createdAt: new Date(),
    },
    {
      ...
      fieldLabel: "Edema",
      fieldType: "select",
      fieldOptions: JSON.stringify(["Ausente", "+/4+", "++/4+", "+++/4+", "++++/4+"]),
      required: false,
      order: 19,
      createdAt: new Date(),
    },
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Habitual", "Intermediário", "Alto Risco"]),
      required: true,
      order: 20,
    ...
    },
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Sim", "Não", "Recusou"]),
      required: false,
      order: 21,
      createdAt: new Date(),
    },
  ...
  const diabetesFields = [
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Tipo 1", "Tipo 2", "Gestacional", "MODY", "Outro"]),
      required: true,
      order: 1,
      createdAt: new Date(),
    },
    {
      ...
      required: false,
      order: 2,
      validationRules: JSON.stringify({ min: 0, max: 80 }),
      createdAt: new Date(),
    },
    {
      id: generateId(),
      ...
      required: false,
      order: 3,
      validationRules: JSON.stringify({ min: 30, max: 600 }),
    ...
    },
    {
      ...
      required: false,
      order: 5,
      validationRules: JSON.stringify({ min: 4.0, max: 18.0 }),
    ...
    },
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Sim (< 7%)", "Não (≥ 7%)", "Não realizado"]),
      required: false,
      order: 6,
      createdAt: new Date(),
    },
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Sim", "Não"]),
      required: true,
      order: 7,
      createdAt: new Date(),
    },
    ...
    },
    {
      ...
      fieldType: "select",
      fieldOptions: JSON.stringify(["Sim", "Não", "Nunca realizado"]),
      required: false,
      order: 13,
      createdAt: new Date(),
    },
