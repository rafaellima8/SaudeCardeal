...
-   **Exams & Procedures Management**: CRUD system for laboratory exam and procedure requests integrated into medical consultations, with SIGTAP integration and multi-tenant security.
